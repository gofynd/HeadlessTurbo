...
const ShipmentDetails = ({ fpi }) => {
  ...
  useThemeConfig({ fpi, page: "shipment-details" });
  ...
  const title = useMemo(() => {
    const base =
      ...
      (brandName ? `Shipment Details | ${brandName}` : "Shipment Details");
  ...
  return (
    <>
      ...
      <div className="basePageContainer margin0auto">
        ...
        {isLoading ? <Loader /> : <OrderDetails fpi={fpi} />}
      </div>
    </>
  );
};
...
export const sections = JSON.stringify([
  {
    canvas: { value: "left_side", label: "Left Panel" },
    attributes: { page: "shipment-details" },
  },
  {
